...
function searchGyms() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const nearbyGyms = await fetchNearbyGyms(Number(enteredLat), Number(enteredLong));
          } 
        catch (error) {
    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" value={enteredLat} onChange={(e) => setEnteredLat(e.target.value)} placeholder='Enter Latitude..'></input>
                <label> Longitude: </label>
                <input type="text" value={enteredLong} onChange={(e) => setEnteredLong(e.target.value)} placeholder='Enter Longitude..'></input>
